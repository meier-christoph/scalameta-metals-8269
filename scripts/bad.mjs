#!/usr/bin/env node
/**
 * Go-to-definition on EXTERNAL symbol ConfEncoder — fails when the definition
 * request is sent before Metals finishes indexing (the race condition that
 * Claude Code's LSP client triggers on Windows).
 *
...
// ── Start Metals ────────────────────────────────────────────────────────────
console.log("=== go-to-definition on EXTERNAL symbol ===");
